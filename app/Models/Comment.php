...
class Comment extends Model
{
    ...
    public function getStatusLabelAttribute(): string
    {
        ...
        return CommentEnum::getStatus()[$this->status] ?? 'نامشخص';
    }
    ...
    public function childrenRecursive(): HasMany
    {
        ...
        return $this->hasMany(Comment::class, 'parent_id')->where('status', CommentEnum::CONFIRMED)->with(['user','childrenRecursive']);
